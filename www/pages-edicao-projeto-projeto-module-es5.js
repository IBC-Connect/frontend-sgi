(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-edicao-projeto-projeto-module"], {
    ...
    /***/
    function Aurc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function EdWE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function kyca(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_servicos_Projeto__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var src_app_util_DiaDaSemanaEHorarioUtil__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/util/DiaDaSemanaEHorarioUtil */
      "itSG");
      /* harmony import */


      var src_app_util_EncontroUtil__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var src_app_validador_ValidadorCamposObrigatorios__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/validador/ValidadorCamposObrigatorios */
      "tyGv");

      var ProjetoPage = /*#__PURE__*/function () {
        function ProjetoPage(projetoService, aviso, router) {
        ...
        _createClass(ProjetoPage, [{
          ...
          value: function inicializar() {
            ...
            this.projeto.dataInicio = this.projeto.dataInicio.includes("/") ? this.projeto.dataInicio : src_app_util_DateUtil__WEBPACK_IMPORTED_MODULE_8__["DateUtil"].dateFormatterBrazil(this.projeto.dataInicio);
          }
        }, {
          key: "disabledBotaoEditar",
          value: function disabledBotaoEditar() {
            return !src_app_validador_ValidadorCamposObrigatorios__WEBPACK_IMPORTED_MODULE_12__["ValidadorCamposObrigatorios"].isCampoPreenchido(this.projeto.nome) || !src_app_validador_ValidadorCamposObrigatorios__WEBPACK_IMPORTED_MODULE_12__["ValidadorCamposObrigatorios"].isCampoPreenchido(this.projeto.dataInicio) || !src_app_validador_ValidadorCamposObrigatorios__WEBPACK_IMPORTED_MODULE_12__["ValidadorCamposObrigatorios"].isCampoPreenchido(this.projeto.descricao);
          }
        }, {
          key: "editar",
          value: function editar() {
            if (this.projeto) {
              if (this.projeto.dataInicio && !src_app_util_DateUtil__WEBPACK_IMPORTED_MODULE_8__["DateUtil"].verificarIsDataValida(this.projeto.dataInicio)) {
    ...
    /***/
    function qH7i(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=pages-edicao-projeto-projeto-module-es5.js.map