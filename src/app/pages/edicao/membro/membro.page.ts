...
export class MembroPage {
  ...
  this.membro.dataBatismo = this.membro.dataBatismo.includes('/')? this.membro.dataBatismo : DateUtil.dateFormatterBrazil(this.membro.dataBatismo);
  if( this.membro.dataNascimento)
  this.membro.dataNascimento = this.membro.dataNascimento.includes('/')? this.membro.dataNascimento : DateUtil.dateFormatterBrazil(this.membro.dataNascimento);
  if( this.membro.membroDesde)
  this.membro.membroDesde = this.membro.membroDesde.includes('/')? this.membro.membroDesde : DateUtil.dateFormatterBrazil(this.membro.membroDesde);
  }
